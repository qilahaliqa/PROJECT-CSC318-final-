...
if ((isset($_GET['psi_t'])) && ($_GET['psi_t'] != "")) {
  $deleteSQL = sprintf("DELETE FROM cust_register WHERE psi_t=%s",
                       GetSQLValueString($_GET['psi_t'], "int"));

  mysql_select_db($database_pustakaseriintan, $pustakaseriintan);
  $Result1 = mysql_query($deleteSQL, $pustakaseriintan) or die(mysql_error());
